...
CREATE TABLE `report_files` (
  ...
  PRIMARY KEY (`file_id`),
  KEY `fk_report_files_report` (`report_id`),
  CONSTRAINT `fk_report_files_report` FOREIGN KEY (`report_id`) REFERENCES `reports` (`report_id`) ON DELETE CASCADE
...
-- Dump completed on 2025-12-29 11:41:21
