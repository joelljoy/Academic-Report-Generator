...
export default function OutreachForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("number_of_beneficiaries", form.number_of_beneficiaries.value);
    formData.append("number_of_student_volunteers", form.number_of_student_volunteers.value);
    ...
    <form className="fdp-form" onSubmit={handleSubmit}>
      <section className="form-section">
        ...
        <div className="form-grid">
          ...
          <input type="text" name="report_type" value="OUTREACH" readOnly />
          ...
          <input name="number_of_beneficiaries" type="number" required />

          <label>Number of Student Volunteers</label>
          <input name="number_of_student_volunteers" type="number" required />

          <label>Student Coordinator</label>
          <textarea name="student_coordinator" rows="2" required />

          <label>Staff Coordinator</label>
          <textarea name="staff_coordinator" rows="2" required />

          <label>Collaborating Agency</label>
          <textarea name="collaborating_agency" rows="2" required />
        </div>
      </section>
